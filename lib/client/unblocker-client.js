(function (global) {
  ...
  if (typeof module === "undefined") {
    global.unblocker = {
      init: initForWindow,
      // todo: define these functions above
      getWindowWrapper: function() {
        return this; // todo: handle writes of window.location
      },
      getLocationWrapper: function() {
        return new URL(config.url); // todo: handle writes and other location methods
      },
      getDocumentWrapper: function() {
