...
`
      ...
      // this stuff just ins't feasible to do with regex's
  ...
  function proxyScriptSync(source, url) {
    try {
      ...
      // this prevents someone from overriding the Object construtor to read the contents of it.
      ...
      console.error(`Error rewriting script: ${er.message}, returning original: ${url}\n${errSrc}`);
      return source;
    }
  }
