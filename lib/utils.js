...
module.exports = {
    ...
    redirectTo: function(request, response, site) {
        ...
        try {
            response.writeHead('302', {
                'Location': this.thisSite(request) + site
            });
    ...
    add_ga: function(html) {
        if (config.google_analytics_id) {
            this.ga = this.ga || [
                "<script type=\"text/javascript\">", "var _gaq = []; // overwrite the existing one, if any", "_gaq.push(['_setAccount', '" + config.google_analytics_id + "']);", "_gaq.push(['_trackPageview']);", "(function() {", "  var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;", "  ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';", "  var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);", "})();", "</script>"
            ].join("\n");
